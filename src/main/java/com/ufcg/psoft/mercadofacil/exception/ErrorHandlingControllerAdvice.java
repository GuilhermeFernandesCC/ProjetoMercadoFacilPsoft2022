...
public class ErrorHandlingControllerAdvice {
    private CustomErrorType defaultCustomErrorTypeConstruct(String errorCode, String message){
    ...
    public CustomErrorType onMethodArgumentNotValidException(MethodArgumentNotValidException e){
        ...
        CustomErrorType customErrorType = defaultCustomErrorTypeConstruct(
                "error.validation.method.argument.not.valid",
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public CustomErrorType onMethodArgumentNotValidException(ConstraintViolationException e){

        CustomErrorType customErrorType = defaultCustomErrorTypeConstruct(
                "error.constraint.violation",
                "Erros de violacao de restricoes nos dados encontrados"
        );
